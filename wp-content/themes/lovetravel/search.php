						...
						<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
								...
								<?php if (has_post_thumbnail()): ?>
									<div class="nicdark_featured_image">
										<a href="<?php the_permalink(); ?>" class="nicdark_btn nicdark_bg_<?php echo $redux_demo['metabox_posts_color']; ?> white medium nicdark_absolute_left"><?php the_time('j') ?><br><small><?php the_time('M') ?></small></a>
